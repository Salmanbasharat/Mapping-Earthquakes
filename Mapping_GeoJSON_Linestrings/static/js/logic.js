...
let torontoData = "https://raw.githubusercontent.com/Salmanbasharat/Mapping-Earthquakes/Mapping_GeoJSON_Linestrings/torontoRoutes.json";
...
d3.json(torontoData).then(function(data) {
  ...
  L.geoJson(data,{
    ...
    onEachFeature: function(feature, layer) {
     layer.bindPopup("<h3> Airline: "+ feature.properties.airline + "</h3><hr></hr3>Destination:"+ feature.properties.dst+"</h3");
